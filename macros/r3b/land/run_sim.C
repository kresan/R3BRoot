void run_sim(Int_t nNeutrons = 4, Int_t nEvents = 100, Int_t beamE = 600, Int_t Erel = 500)
{
    ...
    TString suf = Form("%1dAMeV.%1dn.%1dkeV.%1dm.root", beamE,nNeutrons, Erel, d);
    TString outFile = "r3bsim." + suf;
    TString parFile = "r3bpar." + suf;
    ...
    TString inputFile = Form("%1dSn_%1dn_%dAMeV_%dkeV.dat",132-nNeutrons,nNeutrons,beamE,Erel);
    ...
    // NeuLAND
    run->AddModule(new R3BLand("neuland_v12a_14m.geo.root", { 0., 0., ((Float_t)d*100.) + 15. * 5. }));
