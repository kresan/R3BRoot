...
void create_glad_geo(const char* geoTag, Bool_t create_flunge = kTRUE)
{
...
void ConstructFlunge(TGeoVolume* pWorld)
{
    ...
    TGeoVolumeAssembly* flunge_world = new TGeoVolumeAssembly("Flunge");
    ...
    TGeoUnion* flunge_u = new TGeoUnion(f_tube, f_secondary, 0, m_tube_2);
    TGeoShape* flunge_u_shape = new TGeoCompositeShape("FlungeDiscTube", flunge_u);
    ...
    TGeoSubtraction* flunge_u_c = new TGeoSubtraction(flunge_u_shape, f_cut, 0, m_cut);
    TGeoShape* flunge_u_c_shape = new TGeoCompositeShape("FlungeDiscTubeCut", flunge_u_c);
    
    TGeoMedium* pMedFe = gGeoManager->GetMedium("iron");
    TGeoVolume* vol_tube = new TGeoVolume("Flunge_disc", flunge_u_c_shape, pMedFe);
    
    TGeoCombiTrans* m_disc = new TGeoCombiTrans(0., 0., 0., zero_rot);
    flunge_world->AddNode(vol_tube, 0, m_disc);
    
    TGeoCombiTrans* m1 = new TGeoCombiTrans(-1. * flunge_z_offset, -4., 0., rot1);
    pWorld->AddNode(flunge_world, 0, m1);
}
